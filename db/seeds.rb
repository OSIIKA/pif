...
ships = [
  ...
  # ===========================
  {
    ...
    info: "紫鉄艦隊の基礎となる試作艦。",
    image_url: "/img/ships/shitetu_01.png",
  ...
  },
  {
    ...
    info: "試作型を改修した量産モデル。",
    image_url: "/img/ships/shitetu_02.png",
  ...
  },
  {
    ...
    info: "紫鉄艦隊の象徴となる高性能艦。",
    image_url: "/img/ships/shitetu_03.png",
  ...
  # ===========================
  {
    ...
    info: "てんぷれ",
    image_url: "/img/ships/enemy_01.png",
  ...
  },
  {
    ...
    hp: 100, max_hp: 100, atk: 25, speed: 10,
    info: "てんぷれ",
    image_url: "/img/ships/enemy_02.png",
  ...
  },
  {
    ...
    hp: 100, max_hp: 100, atk: 25, speed: 10,
    info: "てんぷれ",
    image_url: "/img/ships/enemy_03.png",
  ...
  },
  {
    ...
    hp: 100, max_hp: 100, atk: 25, speed: 10,
    info: "てんぷれ",
    image_url: "/img/ships/enemy_04.png",
  ...
  },
  {
    ...
    hp: 100, max_hp: 100, atk: 25, speed: 10,
    info: "てんぷれ",
    image_url: "/img/ships/enemy_05.png",
...
# 📚アイテム辞書
# ===========================
def ___📚アイテム辞書___; end
puts "🌱 アイテム辞書のシードを開始します..."
...
# puts "✨ アイテム辞書のシードが完了しました！"
# ===========================
# 📚キャラクター辞書
# ===========================
def ___📚キャラクター辞書___; end
puts "🌱 キャラクター辞書のシードを開始します..."
...
puts "✨ 武器辞書のシードが完了しました！"
# ===========================
# 📚アイテム配布データ
# ===========================
def ___📚アイテム配布データ___; end
puts "🌱 アイテム配布データのシードを開始します..."
timelines = [
  # ===========================
  # 📕ガチャボーナス（レアガチャ）
  # ===========================
...
puts "✨ アイテム配布データのシードが完了しました！"
# ===========================
# 📚イベント辞書
# ===========================
def ___📚イベント辞書___; end
puts "🌱 イベント辞書のシードを開始します..."
...
puts "✨ イベント辞書のシードが完了しました！"
# ===========================
# 📚敵個体辞書
# ===========================
def ___📚敵個体辞書___; end
puts "🌱 敵個体辞書のシードを開始します..."
# 1. 敵個体の作成 (EnemyFreet)
...
puts "✨ 敵個体辞書のシードが完了しました！"
# ===========================
# 📚敵艦隊編成辞書
# ===========================
def ___📚敵艦隊編成辞書___; end
puts "🌱 敵艦隊編成辞書のシードを開始します..."
...
puts "✨ 敵艦隊編成辞書のシードが完了しました！"
# ===========================
# 📚ストーリーデータ
# ===========================
def ___📚ストーリーデータ___; end
puts "🌱 ストーリーデータのシードを開始します..."
# 既存データを一度お掃除
Story.delete_all
